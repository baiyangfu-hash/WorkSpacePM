...
- current_focus: **CHG-DOCU-2026-008 已完成验收、关闭并提交；活动技术债台账已登记 Windows COM 0x80040155、全仓 Mypy 基线 42/18、历史 CHG 结构告警、PM_SESSION 状态漂移。CHG-SCPT-2026-197 P2 连续性整改、CHG-SCPT-2026-193 共享 CHG 契约证据回收及 CHG-SCPT-2026-194 实质内容门禁均已验收关闭，均未发布、未切流。下一包为 CHG-SCPT-2026-195 的 Windows COM 隔离阶段 0/1；CHG-SCPT-2026-196 仍暂停。**
- risks_dependencies:
...
- [待阶段 0/1] CHG-SCPT-2026-195 | precondition=复现或隔离 Windows COM `0x80040155`，明确测试/运行时边界与最小修复范围；done_when=提交证据、影响范围和实施计划，等待用户明确批准。
